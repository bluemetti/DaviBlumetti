    ...
    <footer className="bg-black/30 backdrop-blur-md border-t border-white/10 mt-20">
      <div className="container mx-auto px-4 py-8">
        <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
          <div>
            <h3 className="text-xl font-bold mb-4">Davi Blumetti</h3>
          ...
          <div>
            ...
            <div className="flex space-x-4">
              <a
                href="https://github.com/bluemetti"
                target="_blank"
              ...
              <a
                href="https://linkedin.com/in/davi-blumetti"
                target="_blank"
                rel="noopener noreferrer"
                className="text-gray-300 hover:text-white transition-colors"
              >
        ...
        <div className="border-t border-white/10 mt-8 pt-8 text-center text-gray-300">
          <p>&copy; 2025 Davi Blumetti. Todos os direitos reservados.</p>
        </div>
      </div>
    </footer>
  );
